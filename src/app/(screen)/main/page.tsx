const Main = () => {
  return (
    <>
      <section id="banner">
        <img src="/images/background/banner_bg.png" alt="배너 배경" />
      </section>
      ...
      <section id="intro">
        <div className="intro__inner">
          ...
          <div className="intro__btn_cont">
            <div>
              <img src="/images/contents/rabbit_face.png" alt="토끼 얼굴" />
              <p>프로그램 일정</p>
            </div>
            <div>
              <img src="/images/contents/rabbit_face.png" alt="토끼 얼굴" />
          ...
          <div className="intro__banner">
            <img src="/images/contents/intro_banner.png" alt="배너 이미지" />
          </div>
          <div className="intro__bottom">
            <img src="/images/contents/intro_bottom.png" alt="배너 이미지" />
          </div>
        </div>
      </section>
  </>
